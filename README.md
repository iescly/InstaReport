...
> ⚠️ **A valid license key is required to use InstaReport.** [Purchase one here →](https://instagramban.lovable.app/pricing)
...
2️⃣  Clone & install InstaReport
3️⃣  Enter your license key when prompted
